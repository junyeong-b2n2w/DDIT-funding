				...
				<div class="container">
					<div class="row">
						<div class="col-md-2 col-lg-2 col-sm-3 col-xs-3">
							<div class="logo">
								<a href="<%=request.getContextPath() %>/index"> <span style="font-size: 2rem">펀하딩</span>
								</a>
							</div>
						</div>
						<!-- Start MAinmenu Ares -->
			...
			<div class="offsetmenu">
				<div class="offsetmenu__inner">
					...
					<div class="off__contact">
						<div class="logo">
							<a href="index.html"> <img src="<%=request.getContextPath() %>/resources/images/logo/logo.png" alt="logo">
							</a>
						</div>
					...
					<div class="shp__cart__wrap">
						<div class="shp__single__product">
							<div class="shp__pro__thumb">
								<a href="#"> <img src="<%=request.getContextPath() %>/resources/images/product/sm-img/1.jpg" alt="product images">
								</a>
							</div>
						...
						<div class="shp__single__product">
							<div class="shp__pro__thumb">
								<a href="#"> <img src="<%=request.getContextPath() %>/resources/images/product/sm-img/2.jpg" alt="product images">
								</a>
							</div>
							<div class="shp__pro__details">
								<h2>
